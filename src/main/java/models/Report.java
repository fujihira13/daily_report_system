...
@NamedQueries({
    ...
    @NamedQuery(
            name = JpaConst.Q_FOLLOW_GET_ALL_MINE_REPORT,
            query = JpaConst.Q_FOLLOW_GET_ALL_MINE__REPORT_DEF),
    @NamedQuery(
            name = JpaConst.Q_REP_COUNT_ALL_FOLLOW_MINE,
            query = JpaConst.Q_REP_COUNT_ALL_FOLLOW_MINE_DEF)
})
